...
/* [SHEET 변형] 원본 components/sections/VenueMap.tsx 클론.
   ★ 열 강조색만 spectral 채도 레드(#ff122e)로 교체 (원본은 오렌지 #E84A20). */
const HEAT = "#ff122e";
const INK = "#0A0A0A";
...
export default function VenueMap() {
  return (
    ...
    >
      ...
      {/* 상단 회의실 열 */}
      {/* 301호 (목적지, 열 강조) */}
      <rect x="44" y="64" width="360" height="150" fill="rgba(255,18,46,0.1)" stroke={HEAT} strokeWidth="2" />
