...
/* [PROCESS 변형] 원본 components/sections/VenueMap.tsx 클론.
   ★ 강조색만 프로세스 잉크색(마젠타 #ec008c)으로 교체 (원본은 오렌지 #E84A20). */
const HEAT = "#ec008c"; // CMYK magenta (인쇄 잉크)
const INK = "#0A0A0A";
...
export default function VenueMap() {
  return (
    ...
    >
      ...
      <rect x="44" y="64" width="360" height="150" fill="rgba(236,0,140,0.1)" stroke={HEAT} strokeWidth="2" />
