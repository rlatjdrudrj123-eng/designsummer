...
/* [PROCESS 변형] 원본 components/sections/SpeakerModal.tsx 클론 — 동작·구조·카피 동일.
   대표작 캐러셀 + 세션 설명 + 크레덴셜 + 홈페이지 링크. role=dialog, Esc·스크림 닫힘,
   포커스 트랩, body 스크롤 잠금, 자동 넘김.
   ★ 액센트만 CMYK 잉크: Day1 = 시안 잉크, Day2 = 마젠타 잉크. */
export default function SpeakerModal({
  ...
  // Day1 = 시안 잉크 / Day2 = 마젠타 잉크
  const accent =
    speaker.day === 1 ? "var(--rgb-accent)" : "var(--cmyk-accent)";
