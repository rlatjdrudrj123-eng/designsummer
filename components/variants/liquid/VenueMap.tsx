...
/* [LIQUID 변형] 원본 components/sections/VenueMap.tsx 클론.
   ★ 열 강조색만 액상 무지개 핫 레드(#ff2a1a)로 교체 (원본은 오렌지 #E84A20). */
const HEAT = "#ff2a1a";
const INK = "#0A0A0A";
...
export default function VenueMap() {
  return (
    ...
    >
      ...
      {/* 상단 회의실 열 */}
      {/* 301호 (목적지, 열 강조) */}
      <rect x="44" y="64" width="360" height="150" fill="rgba(255,42,26,0.1)" stroke={HEAT} strokeWidth="2" />
