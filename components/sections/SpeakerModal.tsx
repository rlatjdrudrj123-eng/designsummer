...
/* 연사 상세 모달 — 대표작 캐러셀 + 전체 세션 설명 + 크레덴셜 + 홈페이지 링크.
   role=dialog / aria-modal, Esc·스크림 클릭 닫힘, 포커스 트랩, body 스크롤 잠금.
   진입은 열 번짐(blur-in) — reduced-motion 시 정적. 라이브러리 없이 CSS·setInterval만. */
