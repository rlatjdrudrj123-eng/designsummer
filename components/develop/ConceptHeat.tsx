...
/* D1/D2 컨셉 열 오브제 — KV 와 동일한 열 렌더(LUT·도메인 워프) 위에, 각 날의
   컨셉을 "명확한 구조"로 표현. 히어로처럼 커서가 닿으면 열이 번진다(잔열 감쇠).
   D1 열원(HEAT SOURCE): 중심 코어에서 동심원 파동이 바깥으로 퍼져나간다.
   D2 전사(HEAT TRANSFER)=확장: 중심에서 양 대각으로 뻗는 두 화살표(↗·↙)가 함께 벌어진다.
   reduced-motion: 파동/확장 정지. */
