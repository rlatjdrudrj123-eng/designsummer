...
export const conference = {
  ...
  overview: {
    ...
    intro: [
      ...
      "올해 '디자인 썸머 일산'은 그 뜨거운 현장을 'the creative heatwave'라는 슬로건에 담았습니다.\n보기 좋은 결과물을 넘어, 디자인이 비즈니스를 거쳐 실물로 완성되기까지의 과정을 이틀에 걸쳐 다룹니다.",
      "결과물을 통해 증명해 온 스페셜리스트 8인의 경험에서 실질적인 인사이트를 얻어가시기 바랍니다.",
    ],
    days: [
      {
        day: 1,
  ...
  timetable: {
    day1: {
      ...
      rows: [
        ...
        { time: "13:55 - 14:40", studio: "오디너리피플", speaker: "서정민 디자이너", title: "브랜드를 만드는 세 가지 질문", desc: "정의에서 표현으로, 표현에서 접점으로 이어지는 브랜드 디자인 실무 프로세스와 아이덴티티 시각화 노하우를 다룹니다." },
        { time: "14:40 - 14:50", title: "Coffee Break (중간 휴식 · 10분)", kind: "break" },
        { time: "14:50 - 15:35", studio: "우트크리에이티브", speaker: "고성우 디렉터", title: "필요 없는 건 다 끕니다: 예쁜 걸 넘어 설득이 되는 모션그래픽", desc: "불필요한 요소를 배제하고 본질만 남기는 디렉팅 기준과 화면 속 스틸컷이 실물 패키지로 연결된 프로젝트 사례를 소개합니다." },
    ...
    day2: {
      ...
      rows: [
        { time: "12:00 - 13:00", title: "registration", kind: "reg" },
        { time: "13:00 - 13:45", studio: "아우라지디자인", speaker: "박진택 디렉터", title: "컨셉을 관통하는 창의적인 브랜드 비주얼", desc: "브랜드 에센스를 명확한 시각 컨셉과 키비주얼로 번역하고, 다양한 B2C 매체 전반으로 확장·적용하는 실무 프로세스입니다." },
        { time: "13:55 - 14:40", studio: "오세븐", speaker: "배수규 대표", title: "디자인은 취향이 아닌 비즈니스다", desc: "실제 경쟁 입찰 및 기업 프로젝트 사례 분석을 통해, 왜 특정 디자인이 최종안으로 선택될 수밖에 없었는지 그 비즈니스적 배경을 밝힙니다." },
        { time: "14:40 - 14:50", title: "Coffee Break (중간 휴식 · 10분)", kind: "break" },
        ...
        { time: "15:45 - 16:30", studio: "패터니스튜디오", speaker: "이요안나 디자이너", title: "패턴디자인 출력에서 고려해야 할 내용", desc: "지류, 원단, 상업 패키지 등 매체별 바탕지의 특성과 출력 설정값에 따른 결과물 편차를 예방하기 위한 사전 체크포인트를 다룹니다." },
      ] as TimetableRow[],
    },
  },
  ...
  /* ── FAQ ──────────────────────────────────────────────────────────────── */
  faq: [
    { q: "Day 1과 Day 2 양일 모두 참석하고 싶은데 어떻게 해야 하나요?", a: "Day 1과 Day 2는 각각 별도의 등록 폼으로 운영됩니다. 양일 모두 참석을 원하실 경우, 번거로우시더라도 두 일자의 사전등록을 각각 진행해 주셔야 합니다." },
    { q: "특정 연사의 세션 하나만 듣고 싶은데, 부분 등록이 가능한가요?", a: "세션별 개별 등록은 불가능하며, 일자별(Day 1 또는 Day 2) 통합 등록으로만 진행됩니다. 해당 일자에 등록하시면 그날의 모든 세션을 자유롭게 수강하실 수 있습니다." },
    { q: "사전등록을 하지 못했는데, 현장 등록도 가능한가요?", a: "일자별 좌석 제약으로 인해 사전등록제를 우선으로 합니다. 사전등록 취소분에 한하여 당일 현장 등록 데스크를 일부 운영할 예정이나, 조기 마감될 수 있습니다." },
    { q: "컨퍼런스 참석 시 동시 개최되는 K-PRINT 2026 전시회도 볼 수 있나요?", a: "네, 컨퍼런스 사전등록이 완료되신 분들은 동일 기간 개최되는 'K-PRINT 2026' 전시장 무료 관람 출입증을 함께 발급해 드립니다." },
  ],
} as const;
